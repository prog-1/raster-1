...
var c = color.RGBA{R: 0xff, G: 0x00, B: 0x00, A: 0xff}
...
func (g *Game) rotation() {
	g.p1.x = g.p1.x*math.Cos(0.01) - g.p1.y*math.Sin(0.01) + (250 - 250*math.Cos(0.01) + 250*math.Sin(0.01))
	g.p1.y = g.p1.x*math.Sin(0.01) + g.p1.y*math.Cos(0.01) + (-250*math.Sin(0.01) + 250 - 250*math.Cos(0.01))
	g.p2.x = g.p2.x*math.Cos(0.01) - g.p2.y*math.Sin(0.01) + (250 - 250*math.Cos(0.01) + 250*math.Sin(0.01))
	g.p2.y = g.p2.x*math.Sin(0.01) + g.p2.y*math.Cos(0.01) + (-250*math.Sin(0.01) + 250 - 250*math.Cos(0.01))
}
